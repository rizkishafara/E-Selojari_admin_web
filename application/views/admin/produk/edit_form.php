                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-3">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $produk->kd_brg?>" />
                                    <div class="form-group">
                                        <label for="kd_brg">Kode*</label>
                                        <input class="form-control <?php echo form_error('kd_brg') ? 'is-invalid':'' ?>"
                                        type="text" name="kd_brg" placeholder="Kode Barang" value="<?php echo $produk->kd_brg ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        type="text" name="nm_brg" min="0" placeholder="Nama Barang" value="<?php echo $produk->nm_brg ?>"/>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        type="text" name="satuan" min="0" placeholder="Satuan Barang" value="<?php echo $produk->satuan ?>"/>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        type="number" name="harga" min="0" placeholder="Harga Barang" value="<?php echo $produk->harga ?>"/>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        type="number" name="stok" min="0" placeholder="Stok Barang" value="<?php echo $produk->stok ?>"/>
                                        <div class="invalid-feedback">
